                ...
                ${
                  !preciseEditable
                    ? renderSettingsRow({
                        ...
                        stackedOnNarrow: true,
                        control: html`
                          ${renderSettingsStatus({ kind: location.precise ? "ok" : "muted", label: t(location.precise ? "configPage.deviceSettings.preciseLocationStatuses.enabled" : "configPage.deviceSettings.preciseLocationStatuses.disabled") })}
                          <button
                            type="button"
                            class="btn"
