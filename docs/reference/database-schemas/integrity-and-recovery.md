...
Gateway verifier. Background success refreshes matching verification metadata;
confirmed corruption uses the existing quarantine path and prevents the next
open. Ordinary writes do not invalidate the file identity. Same-inode damage
