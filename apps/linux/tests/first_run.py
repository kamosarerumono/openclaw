...
def drive(binary, *, remote_only, local_start_failure, inline_browser, window_chrome, gateway_switch, gateway_onboarding, desktop_sharing, artifacts_dir):
    try:
        import gi
    ...
    def capture(outcome):
        if artifacts_dir is None:
            return
        if window_chrome or gateway_switch or gateway_onboarding or desktop_sharing:
...
def main():
    ...
    if args.window_chrome or args.gateway_switch or args.gateway_onboarding or args.desktop_sharing:
